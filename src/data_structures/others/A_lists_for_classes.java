...
public class A_lists_for_classes {
    public static void main(String[] args) {
        try {
            //StreamTokenizer in = new StreamTokenizer (new BufferedReader(new InputStreamReader(System.in, "ISO-8859-1")));
            StreamTokenizer in = new StreamTokenizer (new FileReader("C:\\Users\\anki0216\\Desktop\\informatics_solutions\\src\\data_structures\\others\\input.txt"));
